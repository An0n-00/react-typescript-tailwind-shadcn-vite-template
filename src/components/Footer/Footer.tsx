                ...
                <div className="mb-6 grid grid-cols-2 gap-6 md:mb-8 md:grid-cols-4 md:gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 md:space-y-2">
                            <li>
                                <Link
                                    to="https://github.com/[USERNAME]/[TEMPLATE]"
                            ...
                            <li>
                                <Link
                                    to="https://github.com/[USERNAME]/[TEMPLATE]#readme"
                                    className="text-muted-foreground hover:text-foreground text-xs md:text-sm"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                            ...
                            <li>
                                <Link
                                    to="https://github.com/[USERNAME]/[TEMPLATE]/issues"
                                    className="text-muted-foreground hover:text-foreground text-xs md:text-sm"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 md:space-y-2">
                            <li>
                                <Link to="https://github.com/[USERNAME]" className="text-muted-foreground hover:text-foreground text-xs md:text-sm" target="_blank" rel="noopener noreferrer">
                                    [USERNAME] on GitHub
                                </Link>
                            </li>
                        </ul>
