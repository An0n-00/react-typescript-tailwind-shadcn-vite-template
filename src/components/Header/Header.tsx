            ...
            >
                <div className="flex items-center gap-2">
                    <Link to="/" className="flex items-center gap-2 transition-opacity hover:opacity-80">
                        <h1 className="text-primary text-lg font-bold">[TEMPLATE]</h1>
                    </Link>
                </div>
                ...
                <NavigationMenu className="hidden md:flex">
                    <NavigationMenuList>
                        ...
                        <NavigationMenuItem>
                            <NavigationMenuLink className={navigationMenuTriggerStyle()} asChild>
                                <Link to="https://github.com/[USERNAME]/[TEMPLATE]/issues" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                                    <div className={'flex items-center gap-2'}>
                                        <span>Help</span>
